...
// tree.add('VP of Happiness', 'CEO', tree.traverseDTree);
// tree.add('VP of Finance', 'CEO', tree.traverseDTree);
// tree.add('VP of Sadness', 'CEO', tree.traverseDTree);
 
// tree.add('Director of Puppies', 'VP of Finance', tree.traverseDTree);
// tree.add('Manager of Puppies', 'Director of Puppies', tree.traverseDTree);
// console.log(tree);
